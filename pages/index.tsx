...
const Home: NextPage = () => {
  ...
  // type ImageItem = { id: string, url: string }; // Moved to global types
  ...
  const addNewFox: MouseEventHandler<HTMLButtonElement> = (event) => {
    ...
    const newImageItem: IImageItem = { id: generateId(), url: `https://randomfox.ca/images/${randomNumber()}.jpg` };
  ...
  return (
    <div>
      <Head>
        ...
        {/* When we use scripts that extends global methods as window for example, 
        usually we have to create add its types, because typescript doesn't know 
        we are using it unless we install it or create its types manually */}
        {/* <script
          defer
